...
function Input({
  ...
  variant = "default",
  ...props
}: React.ComponentProps<"input"> & { variant?: "default" | "highlight" }) {
  return (
    <input
      type={type}
      data-slot="input"
      className={cn(
        ...
        variant === "highlight" && "border border-input focus-visible:border-ring focus-visible:ring-ring/50 focus-visible:ring-[3px]",
        className
      )}
      {...props}
    />
